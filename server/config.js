...
const STATIC_READ_CONCURRENCY = positiveNumber(process.env.STATIC_READ_CONCURRENCY, 128);
const STATIC_READ_QUEUE_LIMIT = positiveNumber(process.env.STATIC_READ_QUEUE_LIMIT, 1024);
